...
//更新课程营销信息
export const updateCourseMarket = params => {
  return http.requestPost(apiUrl+'/course/courseMarket/save/',params)
}
...
export const preview = id => {
  return http.requestQuickGet(apiUrl+'/course/preview/'+id);
}
/*发布课程*/
export const publish = id => {
  return http.requestQuickGet(apiUrl+'/course/publish/'+id);
}
//查询课程信息
